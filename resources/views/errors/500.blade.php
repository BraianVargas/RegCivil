...
@section('title', trans('adminlte::adminlte.500error'))

@section('content_header', trans('adminlte::adminlte.500error'))

@section('content')
    <div class="error-page">
        <h2 class="headline text-red">500</h2>
        <div class="error-content">
            <h3><i class="fa fa-warning text-red"></i> Oops! {{ trans('adminlte::adminlte.500error') }}</h3>
            <p>
                {{ trans('adminlte::adminlte.wewillwork') }}
